...
let s:test_file = s:test_dir . "/test.cpp"
...
function! snowdrop#verify#includes()
	let result = sort(snowdrop#includes(snowdrop#context#file(s:test_file, { "option" : "-I" . s:test_dir } )))
	return len(result) == 2
...
function! snowdrop#verify#typeof()
	let result = snowdrop#typeof(snowdrop#context#file(s:test_file, {  "option" : "-I" . s:test_dir, "line" : 6, "col" : 2 }))
	return result.spelling is# "X"
endfunction


function! snowdrop#verify#code_complete()
	let result = snowdrop#code_complete_in_cursor(snowdrop#context#file(s:test_file, { "option" : "-I" . s:test_dir, "line" : 7, "col" : 3 }))
